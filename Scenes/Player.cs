...
{ 
	...
	public override void _Process(double delta)
	{
		...
		if (Input.IsActionPressed("ui_up")){
			Position = new Vector2(Position.X, Position.Y- main.PADDLE_SPEED* (float)delta);
		...
		Position = new Vector2(Position.X, Mathf.Clamp(Position.Y, p_height / 2, win_height - p_height / 2));
